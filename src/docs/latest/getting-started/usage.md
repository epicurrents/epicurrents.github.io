...
Even though Epicurrents as an application is platform-agnostic, some features of the default library require the use of a mouse and keyboard, and some advanced features may not be usable on touch-screen devices.
